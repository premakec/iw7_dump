...
function JackalBoosterChevronsLeft( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 366 * _1080p, 0, 32 * _1080p )
	self.id = "JackalBoosterChevronsLeft"
	self._animationSets = {}
	self._sequences = {}
...
MenuBuilder.registerType( "JackalBoosterChevronsLeft", JackalBoosterChevronsLeft )
LockTable( _M )
