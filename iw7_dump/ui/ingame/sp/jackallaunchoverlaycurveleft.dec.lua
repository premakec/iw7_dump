...
function JackalLaunchOverlayCurveLeft( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 128 * _1080p, 0, 750 * _1080p )
	self.id = "JackalLaunchOverlayCurveLeft"
	self._animationSets = {}
	self._sequences = {}
	...
	Fill:SetAnchorsAndPosition( 0, 1, 1, 0, 0, _1080p * 128, 0, 0 )
	...
	Mask:SetAnchorsAndPosition( 0, 1, 0.5, 0.5, 0, _1080p * 128, _1080p * -374, _1080p * 374 )
	...
	Bracket:SetAnchorsAndPosition( 0, 1, 0.5, 0.5, 0, _1080p * 128, _1080p * -374, _1080p * 374 )
...
MenuBuilder.registerType( "JackalLaunchOverlayCurveLeft", JackalLaunchOverlayCurveLeft )
LockTable( _M )
