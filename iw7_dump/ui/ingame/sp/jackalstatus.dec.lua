...
f0_local1 = function ( f1_arg0, f1_arg1, f1_arg2 )
	assert( f1_arg0.Fill and f1_arg0.StatusText, "WARNING: Jackal Status Items Are Missing..." )
	...
	local f1_local2 = DataSources.inGame.SP.pearlHarbor.jackalStreakEquipped
	local f1_local3 = DataSources.inGame.SP.pearlHarbor.jackalReady
	local f1_local4 = DataSources.inGame.SP.pearlHarbor.jackalCooldown
	f1_local0:SubscribeToModel( f1_local4:GetModel( f1_arg1 ), function ()
		f1_local0:SetRightAnchor( 1 - f1_local4:GetValue( f1_arg1 ) )
	end )
	f1_arg0:SubscribeToModel( f1_local2:GetModel( f1_arg1 ), function ()
		local f3_local0 = f1_local2:GetValue( f1_arg1 )
		local f3_local1 = f1_arg0
	...
	f1_arg0:SubscribeToModel( f1_local3:GetModel( f1_arg1 ), function ()
		...
		if f4_local0 then
			...
			if f4_local0 == f0_local0.Unavailable then
				...
				f1_local1:setText( ToUpperCase( Engine.Localize( "PHSTREETS_TRANSPONDER_OUTOFRANGE" ) ), 0 )
			elseif f4_local0 == f0_local0.Available then
				...
				f1_local1:setText( ToUpperCase( Engine.Localize( "JACKAL_IN_RANGE" ) ), 0 )
				ACTIONS.AnimateSequence( f1_arg0, "NotifyOn" )
			elseif f4_local0 == f0_local0.Active then
				f1_local0:SetRGBFromTable( SWATCHES.HUD.statusFill_Active, 0 )
				f1_local1:SetRGBFromTable( SWATCHES.HUD.statusFill_Active, 0 )
				f1_local1:setText( ToUpperCase( Engine.Localize( "JACKAL_ACTIVE" ) ), 0 )
...
function JackalStatus( menu, controller )
	...
	StatusText:setText( Engine.Localize( "PHSTREETS_TRANSPONDER_OUTOFRANGE" ), 0 )
...
MenuBuilder.registerType( "JackalStatus", JackalStatus )
LockTable( _M )
