...
function JackalInteriorDisplayOverlayLarge( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1024 * _1080p, 0, 512 * _1080p )
	self.id = "JackalInteriorDisplayOverlayLarge"
	self._animationSets = {}
	self._sequences = {}
	...
	WarningImage:setImage( RegisterMaterial( "hud_jackal_interior_warning" ), 0 )
	...
	IncomingImage:setImage( RegisterMaterial( "hud_jackal_interior_caution" ), 0 )
...
MenuBuilder.registerType( "JackalInteriorDisplayOverlayLarge", JackalInteriorDisplayOverlayLarge )
LockTable( _M )
