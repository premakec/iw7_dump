...
function JackalTargetLockonLeadDotE( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 3 * _1080p, 0, 3 * _1080p )
	self.id = "JackalTargetLockonLeadDotE"
...
MenuBuilder.registerType( "JackalTargetLockonLeadDotE", JackalTargetLockonLeadDotE )
LockTable( _M )
