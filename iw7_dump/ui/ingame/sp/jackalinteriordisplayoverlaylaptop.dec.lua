...
function JackalInteriorDisplayOverlayLaptop( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 512 * _1080p, 0, 256 * _1080p )
	self.id = "JackalInteriorDisplayOverlayLaptop"
	self._animationSets = {}
	self._sequences = {}
	...
	WarningImage:setImage( RegisterMaterial( "hud_jackal_interior_laptop_base_warning" ), 0 )
	...
	IncomingImage:setImage( RegisterMaterial( "hud_jackal_interior_laptop_base_caution" ), 0 )
		...
		WarningImage:RegisterAnimationSequence( "Warning", {
			{
				...
				function ()
					return self.WarningImage:SetAlpha( 0, 140 )
				end,
				function ()
					return self.WarningImage:SetAlpha( 1, 100 )
				end
			}
		} )
...
MenuBuilder.registerType( "JackalInteriorDisplayOverlayLaptop", JackalInteriorDisplayOverlayLaptop )
LockTable( _M )
