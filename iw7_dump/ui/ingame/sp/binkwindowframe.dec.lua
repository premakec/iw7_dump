...
function BinkWindowFrame( menu, controller )
	...
	DigiText1:SetAnchorsAndPosition( 0, 0, 0, 1, 0, _1080p * -30, _1080p * 15, _1080p * 27 )
	...
	DigiText2:SetAnchorsAndPosition( 0, 0, 1, 0, 0, _1080p * -30, _1080p * -29, _1080p * -17 )
	...
	ContentLabel:SetAnchorsAndPosition( 0, 0, 1, 0, _1080p * 30, 0, _1080p * -29, _1080p * -17 )
	...
	IncomingTransmissionText:SetAnchorsAndPosition( 0, 0, 0, 1, _1080p * 30, 0, _1080p * 12, _1080p * 34 )
...
MenuBuilder.registerType( "BinkWindowFrame", BinkWindowFrame )
LockTable( _M )
