...
function JackalOffscreenIndicatorEnemy( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 96 * _1080p, 0, 96 * _1080p )
	self.id = "JackalOffscreenIndicatorEnemy"
	self._animationSets = {}
	self._sequences = {}
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		ArrowInit:RegisterAnimationSequence( "InitArrow", {
			...
			},
			{
				...
				function ()
					return self.ArrowInit:SetRGBFromTable( SWATCHES.jackal.target, 120 )
				end,
				function ()
					return self.ArrowInit:SetRGBFromTable( SWATCHES.jackal.target, 30 )
				end,
				function ()
				...
				function ()
					return self.ArrowInit:SetRGBFromTable( SWATCHES.jackal.target, 110 )
				end,
				function ()
					return self.ArrowInit:SetRGBFromTable( SWATCHES.jackal.target, 30 )
				end
...
MenuBuilder.registerType( "JackalOffscreenIndicatorEnemy", JackalOffscreenIndicatorEnemy )
LockTable( _M )
