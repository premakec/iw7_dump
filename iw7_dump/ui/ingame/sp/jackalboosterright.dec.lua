...
function PostLoadFunc( f1_arg0, f1_arg1, f1_arg2 )
	...
	local f1_local2 = function ( f2_arg0 )
		...
		local f2_local5 = 5 * _1080p
		local f2_local6 = 10 * _1080p
		local f2_local7 = f2_local4 + f2_local5
		f1_arg0.LabelText:SetRight( f2_local7, 0 )
		f1_arg0.Node:SetLeft( f2_local7, 100 )
		f1_arg0.Node:SetRight( f2_local7 + f2_local6, 100 )
	end
	...
	f1_arg0:SubscribeToModel( f1_local4, function ()
		...
		if DataModel.GetModelValue( f1_local3 ) == JackalBoosterStates.Priming then
			...
			f1_arg0.StaticChevrons:SetLeftAnchor( 1 - f4_local1 )
		end
	end )
...
function JackalBoosterRight( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 512 * _1080p, 0, 75 * _1080p )
	self.id = "JackalBoosterRight"
	self._animationSets = {}
	self._sequences = {}
	...
	Chevrons = MenuBuilder.BuildRegisteredType( "JackalBoosterChevronsRight", {
	...
	StaticChevrons:SetZRotation( 180, 0 )
	...
	Highlight = MenuBuilder.BuildRegisteredType( "JackalBoosterHighlightRight", {
		controllerIndex = f6_local1
	} )
	Highlight.id = "Highlight"
	Highlight:SetRGBFromTable( SWATCHES.jackal.thrustBarStable, 0 )
	Highlight:SetAlpha( 0.07, 0 )
	Highlight:SetAnchorsAndPosition( 0, 0, 1, 0, 0, 0, _1080p * -51, _1080p * -9 )
	...
	TechyDigitsText:SetAlignment( LUI.Alignment.Right )
	TechyDigitsText:SetAnchorsAndPosition( 1, 0, 0, 1, _1080p * -125, _1080p * -10, 0, _1080p * 20 )
	...
	DamageText:SetFontSize( 20 * _1080p )
	DamageText:SetFont( FONTS.GetFont( FONTS.MainMedium.File ) )
	DamageText:SetAlignment( LUI.Alignment.Right )
	DamageText:SetAnchorsAndPosition( 1, 0, 0, 1, _1080p * -125, _1080p * -10, 0, _1080p * 20 )
	...
	PercentageText:SetFontSize( 20 * _1080p )
	PercentageText:SetFont( FONTS.GetFont( FONTS.MainMedium.File ) )
	PercentageText:SetAlignment( LUI.Alignment.Right )
	PercentageText:SetAnchorsAndPosition( 1, 0, 0, 1, _1080p * -125, _1080p * -10, 0, _1080p * 20 )
	...
	LabelText:SetFontSize( 20 * _1080p )
	LabelText:SetFont( FONTS.GetFont( FONTS.MainMedium.File ) )
	LabelText:SetAlignment( LUI.Alignment.Left )
	LabelText:SetAnchorsAndPosition( 0, 1, 0, 1, 0, _1080p * 140, 0, _1080p * 20 )
	...
	Node:SetUseAA( true )
	Node:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 140, _1080p * 150, _1080p * 5, _1080p * 15 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		self._sequences.Damaged = function ()
			BackgroundGlow:AnimateSequence( "Damaged" )
			Chevrons:AnimateSequence( "Damaged" )
			StaticChevrons:AnimateSequence( "Damaged" )
			Highlight:AnimateSequence( "Damaged" )
			LineBottom:AnimateSequence( "Damaged" )
			LineTop:AnimateSequence( "Damaged" )
			TechyDigitsText:AnimateSequence( "Damaged" )
			DamageText:AnimateSequence( "Damaged" )
			PercentageText:AnimateSequence( "Damaged" )
			LabelText:AnimateSequence( "Damaged" )
			Node:AnimateSequence( "Damaged" )
		end
...
MenuBuilder.registerType( "JackalBoosterRight", JackalBoosterRight )
LockTable( _M )
