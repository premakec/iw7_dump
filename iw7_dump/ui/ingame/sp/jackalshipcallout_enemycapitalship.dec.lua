...
function JackalShipCallout_enemyCapitalShip( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 10 * _1080p, 0, 10 * _1080p )
	self.id = "JackalShipCallout_enemyCapitalShip"
	...
	HorizontalLine1:SetRGBFromTable( SWATCHES.jackal.calloutLineEnemy, 0 )
	...
	Distance:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * 68, _1080p * 383, _1080p * -62, _1080p * -44 )
	...
	DiagnolLineCopy0:SetRGBFromTable( SWATCHES.jackal.calloutLineEnemy, 0 )
	...
	DiagnolLineCopy1:SetRGBFromTable( SWATCHES.jackal.calloutLineEnemy, 0 )
	...
	node.id = "node"
	node:SetRGBFromTable( SWATCHES.jackal.calloutLineEnemy, 0 )
...
MenuBuilder.registerType( "JackalShipCallout_enemyCapitalShip", JackalShipCallout_enemyCapitalShip )
LockTable( _M )
