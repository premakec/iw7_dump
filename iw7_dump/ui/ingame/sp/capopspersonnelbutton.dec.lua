...
function PostLoadFunc( f1_arg0, f1_arg1 )
	f1_arg0:addEventHandler( "lose_focus", function ( f2_arg0, f2_arg1 )
		...
		if f2_local0.stateDataSource:GetValue( f1_arg1 ) == ShipCribUtils.CapCompStates.OPEN then
...
function CapOpsPersonnelButton( menu, controller )
	local self = LUI.UIButton.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 900 * _1080p, 0, 100 * _1080p )
	self.id = "CapOpsPersonnelButton"
	self._animationSets = {}
	self._sequences = {}
	...
	DescriptionLabel:SetAnchorsAndPosition( 0, 1, 1, 0, _1080p * 35, _1080p * 450, _1080p * -64, _1080p * -42 )
	DescriptionLabel:SubscribeToModelThroughElement( self, "subtitle", function ()
		local f4_local0 = self:GetDataSource()
		f4_local0 = f4_local0.subtitle:GetValue( f3_local1 )
		if f4_local0 ~= nil then
			DescriptionLabel:setText( f4_local0, 0 )
		end
	end )
	...
	MissionTypeLabel:SubscribeToModelThroughElement( self, "charName", function ()
		local f5_local0 = self:GetDataSource()
		f5_local0 = f5_local0.charName:GetValue( f3_local1 )
		if f5_local0 ~= nil then
			MissionTypeLabel:setText( ToUpperCase( f5_local0 ), 0 )
		end
	end )
	...
	LogLabel:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 450, _1080p * 592.5, _1080p * 36, _1080p * 54 )
	...
	LogLabelCopy0:SubscribeToModelThroughElement( self, "index", function ()
		...
		f6_local0 = f6_local0.index:GetValue( f3_local1 )
		if f6_local0 ~= nil then
			LogLabelCopy0:setText( f6_local0, 0 )
		end
	end )
	...
	IsNewIndicator:SubscribeToModelThroughElement( self, "isNewAlpha", function ()
		...
		f7_local0 = f7_local0.isNewAlpha:GetValue( f3_local1 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		DescriptionLabel:RegisterAnimationSequence( "ButtonOver", {
			...
			},
			{
				...
				function ()
					return self.DescriptionLabel:SetAnchorsAndPosition( 0, 1, 1, 0, _1080p * 69.78, _1080p * 484.78, _1080p * -64, _1080p * -42, 100 )
				end
			}
		} )
		MissionTypeLabel:RegisterAnimationSequence( "ButtonOver", {
			...
			{
				function ()
					return self.MissionTypeLabel:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 35, _1080p * 446, _1080p * 7, _1080p * 36, 0 )
				end,
				function ()
					return self.MissionTypeLabel:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 69.78, _1080p * 480.78, _1080p * 7, _1080p * 36, 100 )
				end
			}
		} )
		...
		IsNewIndicator:RegisterAnimationSequence( "ButtonOver", {
			{
				...
				function ()
					return self.IsNewIndicator:SetAnchorsAndPosition( 1, 0, 1, 0, _1080p * -254, _1080p * -210, _1080p * -100.5, _1080p * -56.5, 100 )
				end
			}
		} )
		...
		DescriptionLabel:RegisterAnimationSequence( "ButtonUp2", {
			...
			{
				function ()
					return self.DescriptionLabel:SetAnchorsAndPosition( 0, 1, 1, 0, _1080p * 69.78, _1080p * 480.78, _1080p * -64, _1080p * -42, 0 )
				end,
				function ()
					return self.DescriptionLabel:SetAnchorsAndPosition( 0, 1, 1, 0, _1080p * 35, _1080p * 442, _1080p * -64, _1080p * -42, 100 )
				end
			}
		} )
		MissionTypeLabel:RegisterAnimationSequence( "ButtonUp2", {
			...
			{
				function ()
					return self.MissionTypeLabel:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 69.78, _1080p * 480.78, _1080p * 7, _1080p * 36, 0 )
				end,
				function ()
					return self.MissionTypeLabel:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 35, _1080p * 446, _1080p * 7, _1080p * 36, 100 )
				end
			}
		} )
	...
	self:addEventHandler( "button_over", function ( f104_arg0, f104_arg1 )
		local f104_local0 = f104_arg1.controller or f3_local1
		ACTIONS.AnimateSequence( self, "ButtonOver" )
	end )
	self:addEventHandler( "button_up", function ( f105_arg0, f105_arg1 )
		local f105_local0 = f105_arg1.controller or f3_local1
...
MenuBuilder.registerType( "CapOpsPersonnelButton", CapOpsPersonnelButton )
LockTable( _M )
