...
function JackalOffscreenIndicator( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 96 * _1080p, 0, 96 * _1080p )
	self.id = "JackalOffscreenIndicator"
	self._animationSets = {}
	self._sequences = {}
	...
	ArrowLg:setImage( RegisterMaterial( "hud_jackal_offscreen_carrot_1" ), 0 )
	...
	self:addEventHandler( "pooled_on_allocate", function ( f28_arg0, f28_arg1 )
		local f28_local0 = f28_arg1.controller or f1_local1
...
MenuBuilder.registerType( "JackalOffscreenIndicator", JackalOffscreenIndicator )
LockTable( _M )
