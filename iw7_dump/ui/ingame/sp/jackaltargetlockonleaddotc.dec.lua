...
function JackalTargetLockonLeadDotC( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 3 * _1080p, 0, 3 * _1080p )
	self.id = "JackalTargetLockonLeadDotC"
...
MenuBuilder.registerType( "JackalTargetLockonLeadDotC", JackalTargetLockonLeadDotC )
LockTable( _M )
