...
function JackalShipCallout_allyJackal( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 10 * _1080p, 0, 10 * _1080p )
	self.id = "JackalShipCallout_allyJackal"
	self._animationSets = {}
	self._sequences = {}
...
MenuBuilder.registerType( "JackalShipCallout_allyJackal", JackalShipCallout_allyJackal )
LockTable( _M )
