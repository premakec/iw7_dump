...
function JackalBoosterHighlightLeft( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 366 * _1080p, 0, 32 * _1080p )
	self.id = "JackalBoosterHighlightLeft"
	self._animationSets = {}
	self._sequences = {}
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		Highlight:RegisterAnimationSequence( "Loop", {
			{
				function ()
					return self.Highlight:SetUMin( 1, 0 )
				end,
				function ()
					return self.Highlight:SetUMin( -1.43, 1000 )
				end
			},
			{
				function ()
					return self.Highlight:SetUMax( 2.43, 0 )
				end,
				function ()
					return self.Highlight:SetUMax( 0, 1000 )
				end
			}
		} )
...
MenuBuilder.registerType( "JackalBoosterHighlightLeft", JackalBoosterHighlightLeft )
LockTable( _M )
