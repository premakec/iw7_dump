...
function HaloDropObjective( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920 * _1080p, 0, 1080 * _1080p )
	self.id = "HaloDropObjective"
	self._animationSets = {}
	self._sequences = {}
	...
	DistText:SubscribeToModel( DataSources.inGame.SP.europa.haloDropAltitude:GetModel( f1_local1 ), function ()
		local f2_local0 = DataSources.inGame.SP.europa.haloDropAltitude:GetValue( f1_local1 )
		if f2_local0 ~= nil then
			DistText:setText( f2_local0, 0 )
		end
	end )
	...
	self:SubscribeToModel( DataSources.inGame.SP.europa.haloDropState:GetModel( f1_local1 ), function ()
		...
		if DataSources.inGame.SP.europa.haloDropState:GetValue( f1_local1 ) ~= nil and DataSources.inGame.SP.europa.haloDropState:GetValue( f1_local1 ) == 7 then
			ACTIONS.AnimateSequence( self, "LandingWarning" )
		end
		if DataSources.inGame.SP.europa.haloDropState:GetValue( f1_local1 ) ~= nil and DataSources.inGame.SP.europa.haloDropState:GetValue( f1_local1 ) >= 5 and DataSources.inGame.SP.europa.haloDropState:GetValue( f1_local1 ) ~= nil and DataSources.inGame.SP.europa.haloDropState:GetValue( f1_local1 ) <= 6 then
...
MenuBuilder.registerType( "HaloDropObjective", HaloDropObjective )
LockTable( _M )
