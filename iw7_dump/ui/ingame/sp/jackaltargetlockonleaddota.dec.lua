...
function JackalTargetLockonLeadDotA( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 3 * _1080p, 0, 3 * _1080p )
	self.id = "JackalTargetLockonLeadDotA"
...
MenuBuilder.registerType( "JackalTargetLockonLeadDotA", JackalTargetLockonLeadDotA )
LockTable( _M )
