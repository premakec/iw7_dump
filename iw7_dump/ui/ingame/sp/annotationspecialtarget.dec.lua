...
function AnnotationSpecialTarget( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 32 * _1080p, 0, 32 * _1080p )
	self.id = "AnnotationSpecialTarget"
	...
	caret.id = "caret"
	caret:SetRGBFromTable( SWATCHES.jackal.target, 0 )
...
MenuBuilder.registerType( "AnnotationSpecialTarget", AnnotationSpecialTarget )
LockTable( _M )
