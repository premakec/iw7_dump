...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	local f1_local0 = function ( f2_arg0, f2_arg1 )
		f2_arg0:SetEntityNum( Game.GetOmnvar( "zm_ui_venomx_timer_ent_4" ) )
		f2_arg0:SetEntityTag( "tag_origin" )
		f2_arg0:SetFollowTagAngles( true )
		f2_arg0:SetTagSpacePosition( -12, 0, 0 )
		f2_arg0:SetTagSpaceYaw( 0 )
		f2_arg0:SetTagSpaceRoll( 270 )
	end
	
	f1_arg0:registerOmnvarHandler( "zm_ui_venomx_timer_ent_4", f1_local0 )
	f1_local0( f1_arg0, {} )
end

function empContainer( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 491 * _1080p, 0, 189 * _1080p )
	self.id = "empContainer"
	...
	venomxTimer0:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 51.45, _1080p * 542.45, 0, _1080p * 189 )
...
MenuBuilder.registerType( "empContainer", empContainer )
LockTable( _M )
