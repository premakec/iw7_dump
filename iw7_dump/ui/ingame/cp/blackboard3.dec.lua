...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	local f1_local0 = function ( f2_arg0, f2_arg1 )
		f2_arg0:SetEntityNum( Game.GetOmnvar( "zm_ui_blackboard_3_ent" ) )
	...
	f1_arg0:registerOmnvarHandler( "zm_ui_blackboard_3_ent", f1_local0 )
	f1_local0( f1_arg0, {} )
end

function blackboard3( menu, controller )
	...
	icon.id = "icon"
	icon:setImage( RegisterMaterial( "cp_town_inv_schematic" ), 0 )
...
MenuBuilder.registerType( "blackboard3", blackboard3 )
LockTable( _M )
