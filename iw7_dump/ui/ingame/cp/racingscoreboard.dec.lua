...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	f1_arg0:SetWorldSpacePosition( 3123, -956, 215 )
end

function racingScoreboard( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 491 * _1080p, 0, 160 * _1080p )
	self.id = "racingScoreboard"
	self._animationSets = {}
	self._sequences = {}
	...
	Title:BindAlphaToModel( DataSources.inGame.CP.zombies.arcadeRacingPower:GetModel( f2_local1 ) )
	...
	subtitle:BindAlphaToModel( DataSources.inGame.CP.zombies.arcadeRacingPower:GetModel( f2_local1 ) )
	...
	Label0:BindAlphaToModel( DataSources.inGame.CP.zombies.arcadeRacingCountdown:GetModel( f2_local1 ) )
	...
	Label0Copy0:BindAlphaToModel( DataSources.inGame.CP.zombies.arcadeRacingCountdown:GetModel( f2_local1 ) )
	Label0Copy0:SubscribeToModel( DataSources.inGame.CP.zombies.arcadeRacingCountdown:GetModel( f2_local1 ), function ()
		local f3_local0 = DataSources.inGame.CP.zombies.arcadeRacingCountdown:GetValue( f2_local1 )
	...
	self:SubscribeToModel( DataSources.inGame.CP.zombies.arcadeRacingCountdown:GetModel( f2_local1 ), function ()
		if DataSources.inGame.CP.zombies.arcadeRacingCountdown:GetValue( f2_local1 ) ~= nil and DataSources.inGame.CP.zombies.arcadeRacingCountdown:GetValue( f2_local1 ) == -1 then
			ACTIONS.AnimateSequence( self, "showGo" )
		end
		if DataSources.inGame.CP.zombies.arcadeRacingCountdown:GetValue( f2_local1 ) ~= nil and DataSources.inGame.CP.zombies.arcadeRacingCountdown:GetValue( f2_local1 ) >= 0 then
...
MenuBuilder.registerType( "racingScoreboard", racingScoreboard )
LockTable( _M )
