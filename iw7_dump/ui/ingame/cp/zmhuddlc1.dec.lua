LUI.ZMHUDDLC1 = LUI.Class( LUI.HUD )
...
LUI.ZMHUDDLC1.init = function ( f2_arg0, f2_arg1 )
	LUI.ZMHUDDLC1.super.init( f2_arg0, f2_arg1 )
	f2_arg0.id = "ZMHUDDLC1"
	...
	if f2_local0 then
		...
		if not f2_local1 then
			...
			f2_arg0.reviveBarContainer = f2_arg0:AddWidget( "ReviveBarContainerDLC1", {
				scalable = true,
				shakeable = true,
				leftAnchor = false,
				rightAnchor = false,
			...
			f2_arg0.mainPlayerInfo = f2_arg0:AddWidget( "MainPlayerInfoContainerDLC1", {
				scalable = true,
				shakeable = true,
				leftAnchor = true,
				rightAnchor = false,
			...
			f2_arg0.questFullScreenSplash = f2_arg0:AddWidget( "questFullScreenSplashDLC1", {
				scalable = true,
				shakeable = true,
				leftAnchor = true,
				rightAnchor = false,
			...
			f2_arg0.localPlayerZombieSplashes = f2_arg0:AddWidget( "LocalPlayerZombieSplashDLC1Container", {
				scalable = true,
				shakeable = true,
			...
			f2_arg0:registerOmnvarHandler( "zm_ui_player_in_afterlife_arcade", LUI.HUD.UpdateWidgetsVisibility )
			f2_arg0:registerOmnvarHandler( "zombie_afterlife_soul_power_needed", LUI.HUD.UpdateWidgetsVisibility )
			...
			f2_arg0:registerOmnvarHandler( "zm_arcade_emulator", function ( f4_arg0, f4_arg1 )
				...
				elseif f4_arg1.value == "arcade_seaques" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/seaques1.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_plaque" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/plaque1.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_icehock" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/icehock1.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_oink" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/fishing1.bin " .. f4_arg1.controller, f4_arg1.controller )
				...
				elseif f4_arg1.value == "arcade_crackpo" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/crackpo1.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_boxing" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/boxing1.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_keyston" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/keyston1.bin " .. f4_arg1.controller, f4_arg1.controller )
				end
			end )
			...
			local f2_local4 = 6
			for self = 0, f2_local4 - 1, 1 do
				local f2_local8 = DataSources.inGame.MP.splashes.omnvarList[self]
				f2_arg0:SubscribeToModel( f2_local8:GetModel( f2_arg1 ), LUI.ZMHUDDLC1.SplashSubscriptionHelper( f2_local8, DataSources.inGame.MP.splashes.paramList[self], DataSources.inGame.MP.splashes.cardClientIdList[self], f2_arg1 ), true )
			end
			...
			LUI.ZMHUDDLC1.RegisterSplashHandlers( f2_arg0 )
...
LUI.ZMHUDDLC1.GetToggleWidgets = function ( f9_arg0 )
...
LUI.ZMHUDDLC1.SplashSubscriptionHelper = function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
	return function ()
...
LUI.ZMHUDDLC1.RegisterSplashHandlers = function ( f12_arg0 )
