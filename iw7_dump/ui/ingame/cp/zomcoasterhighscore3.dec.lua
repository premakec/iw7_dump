...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	f1_arg0:SetWorldSpacePosition( -690, -2656, 622 )
	...
	local f1_local1 = DataSources.inGame.CP.zombies.coasterPicP3:GetModel( f1_arg1 )
	f1_arg0:SubscribeToModel( f1_local1, f1_local0 )
	f1_arg0:SubscribeToModel( DataSources.inGame.CP.zombies.coasterHighScoreP3:GetModel( f1_arg1 ), function ()
...
function ZomCoasterHighScore3( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 128 * _1080p, 0, 128 * _1080p )
	self.id = "ZomCoasterHighScore3"
	self._animationSets = {}
	self._sequences = {}
	...
	score4:SubscribeToModel( DataSources.inGame.CP.zombies.coasterHighScoreP3:GetModel( f4_local1 ), function ()
		local f5_local0 = DataSources.inGame.CP.zombies.coasterHighScoreP3:GetValue( f4_local1 )
...
MenuBuilder.registerType( "ZomCoasterHighScore3", ZomCoasterHighScore3 )
LockTable( _M )
