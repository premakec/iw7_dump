...
LUI.FlowManager.DisableLetterboxForMenu( "bombCounterContainer" )
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	local f1_local2 = function ()
		...
		ACTIONS.AnimateSequence( f1_arg0.bombCounter, "digit" .. f4_local0 .. "selected" )
...
function bombCounterContainer( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920 * _1080p, 0, 1080 * _1080p )
	self.id = "bombCounterContainer"
	...
	local bombCounter = nil
	
	bombCounter = MenuBuilder.BuildRegisteredType( "bombCounter", {
		controllerIndex = f8_local1
	} )
	bombCounter.id = "bombCounter"
	bombCounter:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 713.5, _1080p * 1206.5, _1080p * 443, _1080p * 637 )
	self:addElement( bombCounter )
	self.bombCounter = bombCounter
	
	PostLoadFunc( self, f8_local1, controller )
	return self
end

MenuBuilder.registerType( "bombCounterContainer", bombCounterContainer )
LockTable( _M )
