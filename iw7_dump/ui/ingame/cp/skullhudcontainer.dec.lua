...
function skullHUDContainer( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920 * _1080p, 0, 1080 * _1080p )
	self.id = "skullHUDContainer"
	self._animationSets = {}
	self._sequences = {}
	...
	ghostArcadeGameSkullDestroyed = MenuBuilder.BuildRegisteredType( "skullDestroyedWidget", {
	...
	ghostArcadeGameWidget = MenuBuilder.BuildRegisteredType( "skullStrikesWidget", {
		controllerIndex = f1_local1
	} )
	ghostArcadeGameWidget.id = "ghostArcadeGameWidget"
	ghostArcadeGameWidget:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 1359, _1080p * 1760, _1080p * 847, _1080p * 979 )
	self:addElement( ghostArcadeGameWidget )
	self.ghostArcadeGameWidget = ghostArcadeGameWidget
	
	local entanglerWidget = nil
	
	entanglerWidget = MenuBuilder.BuildRegisteredType( "skullEntanglerWidget", {
		controllerIndex = f1_local1
	} )
...
MenuBuilder.registerType( "skullHUDContainer", skullHUDContainer )
LockTable( _M )
