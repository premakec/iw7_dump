...
function ReviveBarContainerDLC1( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 256 * _1080p, 0, 64 * _1080p )
	self.id = "ReviveBarContainerDLC1"
	self._animationSets = {}
	self._sequences = {}
	...
	Accent.id = "Accent"
	Accent:setImage( RegisterMaterial( "zm_revive_bar_accent_dlc1" ), 0 )
	...
	Header.id = "Header"
	Header:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 10, _1080p * 160, _1080p * 4, _1080p * 36 )
	self:addElement( Header )
	self.Header = Header
	
	local ProgressBar = nil
	
	ProgressBar = MenuBuilder.BuildRegisteredType( "ReviveProgressBarDLC1", {
		controllerIndex = f4_local1
	} )
	ProgressBar.id = "ProgressBar"
	ProgressBar:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 21, _1080p * 241, _1080p * 18, _1080p * 50 )
...
MenuBuilder.registerType( "ReviveBarContainerDLC1", ReviveBarContainerDLC1 )
LockTable( _M )
