...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	local f1_local0 = function ( f2_arg0, f2_arg1 )
		f2_arg0:SetEntityNum( Game.GetOmnvar( "zm_ui_venomx_timer_ent_1" ) )
	...
	f1_arg0:registerOmnvarHandler( "zm_ui_venomx_timer_ent_1", f1_local0 )
	f1_local0( f1_arg0, {} )
end

function venomxTimerContainer2( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 491 * _1080p, 0, 189 * _1080p )
	self.id = "venomxTimerContainer2"
	...
	venomxTimer0:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * -17.55, _1080p * 473.45, 0, _1080p * 189 )
...
MenuBuilder.registerType( "venomxTimerContainer2", venomxTimerContainer2 )
LockTable( _M )
