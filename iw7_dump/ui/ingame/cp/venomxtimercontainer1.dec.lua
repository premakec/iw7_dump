...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	local f1_local0 = function ( f2_arg0, f2_arg1 )
		f2_arg0:SetEntityNum( Game.GetOmnvar( "zm_ui_venomx_timer_ent_0" ) )
	...
	f1_arg0:registerOmnvarHandler( "zm_ui_venomx_timer_ent_0", f1_local0 )
	f1_local0( f1_arg0, {} )
end

function venomxTimerContainer1( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 491 * _1080p, 0, 189 * _1080p )
	self.id = "venomxTimerContainer1"
...
MenuBuilder.registerType( "venomxTimerContainer1", venomxTimerContainer1 )
LockTable( _M )
