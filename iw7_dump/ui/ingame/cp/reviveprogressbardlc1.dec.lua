...
function ReviveProgressBarDLC1( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 220 * _1080p, 0, 32 * _1080p )
	self.id = "ReviveProgressBarDLC1"
	...
	Fill.id = "Fill"
	Fill:setImage( RegisterMaterial( "zm_revive_bar_fill_dlc1" ), 0 )
	Fill:SetUseAA( true )
...
MenuBuilder.registerType( "ReviveProgressBarDLC1", ReviveProgressBarDLC1 )
LockTable( _M )
