...
function fateTownBacking( menu, controller )
	...
	bg1.id = "bg1"
	bg1:SetScale( -0.07, 0 )
	bg1:setImage( RegisterMaterial( "cp_town_fnf_icon_bg" ), 0 )
	...
	bg2.id = "bg2"
	bg2:SetScale( -0.07, 0 )
	bg2:setImage( RegisterMaterial( "cp_town_fnf_icon_bg" ), 0 )
	...
	bg3.id = "bg3"
	bg3:SetScale( -0.07, 0 )
	bg3:setImage( RegisterMaterial( "cp_town_fnf_icon_bg" ), 0 )
	...
	bg4.id = "bg4"
	bg4:SetScale( -0.07, 0 )
	bg4:setImage( RegisterMaterial( "cp_town_fnf_icon_bg" ), 0 )
	...
	bg5.id = "bg5"
	bg5:SetScale( -0.07, 0 )
	bg5:setImage( RegisterMaterial( "cp_town_fnf_icon_bg" ), 0 )
...
MenuBuilder.registerType( "fateTownBacking", fateTownBacking )
LockTable( _M )
