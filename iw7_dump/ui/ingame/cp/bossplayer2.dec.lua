...
function BossPlayer2( menu, controller )
	...
	Score:SubscribeToModel( DataSources.inGame.CP.zombies.bossTimePlayer2:GetModel( f3_local1 ), function ()
		local f4_local0 = DataSources.inGame.CP.zombies.bossTimePlayer2:GetValue( f3_local1 )
...
MenuBuilder.registerType( "BossPlayer2", BossPlayer2 )
LockTable( _M )
