...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	local f1_local0 = function ( f2_arg0, f2_arg1 )
		f2_arg0:SetEntityNum( Game.GetOmnvar( "zm_ui_blackboard_5_ent" ) )
	...
	f1_arg0:registerOmnvarHandler( "zm_ui_blackboard_5_ent", f1_local0 )
	f1_local0( f1_arg0, {} )
end

function blackboard5( menu, controller )
	...
	icon.id = "icon"
	icon:setImage( RegisterMaterial( "cp_town_inv_elvira_book" ), 0 )
	icon:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 184, _1080p * 575, 0, _1080p * 561 )
...
MenuBuilder.registerType( "blackboard5", blackboard5 )
LockTable( _M )
