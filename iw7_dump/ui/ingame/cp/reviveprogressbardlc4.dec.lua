...
function ReviveProgressBarDLC4( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 220 * _1080p, 0, 32 * _1080p )
	self.id = "ReviveProgressBarDLC4"
	...
	Fill.id = "Fill"
	Fill:setImage( RegisterMaterial( "cp_final_revive_bar_fill" ), 0 )
	Fill:SetUseAA( true )
	Fill:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, _1080p * -127, _1080p * 129, _1080p * -16, _1080p * 16 )
...
MenuBuilder.registerType( "ReviveProgressBarDLC4", ReviveProgressBarDLC4 )
LockTable( _M )
