...
function ReviveProgressBar( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 220 * _1080p, 0, 32 * _1080p )
	self.id = "ReviveProgressBar"
	...
	Fill.id = "Fill"
	Fill:setImage( RegisterMaterial( "zm_revive_bar_fill" ), 0 )
	Fill:SetUseAA( true )
...
MenuBuilder.registerType( "ReviveProgressBar", ReviveProgressBar )
LockTable( _M )
