...
function ReviveBarContainerDLC2( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 256 * _1080p, 0, 64 * _1080p )
	self.id = "ReviveBarContainerDLC2"
	self._animationSets = {}
	self._sequences = {}
	...
	Accent.id = "Accent"
	Accent:setImage( RegisterMaterial( "zm_revive_bar_accent_dlc2" ), 0 )
	Accent:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 1, _1080p * 257, _1080p * -28, _1080p * 100 )
	...
	Header.id = "Header"
	Header:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 59, _1080p * 209, _1080p * -60, _1080p * -28 )
	self:addElement( Header )
	self.Header = Header
	
	local ProgressBar = nil
	
	ProgressBar = MenuBuilder.BuildRegisteredType( "ReviveProgressBarDLC2", {
		controllerIndex = f4_local1
	} )
	ProgressBar.id = "ProgressBar"
	ProgressBar:SetScale( -0.13, 0 )
	ProgressBar:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 41.8, _1080p * 261.8, _1080p * 17, _1080p * 49 )
...
MenuBuilder.registerType( "ReviveBarContainerDLC2", ReviveBarContainerDLC2 )
LockTable( _M )
