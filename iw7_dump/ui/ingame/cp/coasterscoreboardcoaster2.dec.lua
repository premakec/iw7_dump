...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	local f1_local0 = function ( f2_arg0, f2_arg1 )
		f2_arg0:SetEntityNum( Game.GetOmnvar( "zm_coaster2_ent" ) )
	...
	f1_arg0:registerOmnvarHandler( "zm_coaster2_ent", f1_local0 )
	f1_local0( f1_arg0, {} )
end

function coasterScoreboardcoaster2( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 375 * _1080p, 0, 60 * _1080p )
	self.id = "coasterScoreboardcoaster2"
	...
	rider1score:SetAnchorsAndPosition( 0, 1, 0, 1, 0, _1080p * 103, _1080p * 25.5, _1080p * 45.5 )
	rider1score:SubscribeToModel( DataSources.inGame.CP.zombies.coasterScoreP1C2:GetModel( f3_local1 ), function ()
		local f4_local0 = DataSources.inGame.CP.zombies.coasterScoreP1C2:GetValue( f3_local1 )
	...
	rider2score:SetAnchorsAndPosition( 1, 0, 0, 1, _1080p * -100, 0, _1080p * 25.5, _1080p * 45.5 )
	rider2score:SubscribeToModel( DataSources.inGame.CP.zombies.coasterScoreP2C2:GetModel( f3_local1 ), function ()
		local f5_local0 = DataSources.inGame.CP.zombies.coasterScoreP2C2:GetValue( f3_local1 )
...
MenuBuilder.registerType( "coasterScoreboardcoaster2", coasterScoreboardcoaster2 )
LockTable( _M )
