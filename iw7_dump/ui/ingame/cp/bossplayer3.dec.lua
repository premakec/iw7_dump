...
function BossPlayer3( menu, controller )
	...
	Score:SubscribeToModel( DataSources.inGame.CP.zombies.bossTimePlayer3:GetModel( f3_local1 ), function ()
		local f4_local0 = DataSources.inGame.CP.zombies.bossTimePlayer3:GetValue( f3_local1 )
...
MenuBuilder.registerType( "BossPlayer3", BossPlayer3 )
LockTable( _M )
