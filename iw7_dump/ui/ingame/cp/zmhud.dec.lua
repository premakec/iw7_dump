...
LUI.ZMHUD.init = function ( f2_arg0, f2_arg1 )
	LUI.ZMHUD.super.init( f2_arg0, f2_arg1 )
	f2_arg0.id = "ZMHUD"
	...
	if f2_local0 then
		...
		if not f2_local1 then
			...
			f2_arg0.reviveBarContainer = f2_arg0:AddWidget( "ReviveBarContainer", {
				scalable = true,
				shakeable = true,
				leftAnchor = false,
				rightAnchor = false,
			...
			f2_arg0.ticketMachine = f2_arg0:AddWidget( "ZomTicketMachine", {
				scalable = true,
				shakeable = true,
				leftAnchor = false,
				rightAnchor = false,
			...
			f2_arg0.wonderCard = f2_arg0:AddWidget( "HudBottomRight", {
				scalable = true,
				shakeable = true,
				rightAnchor = true,
				bottomAnchor = true,
			...
			f2_arg0.mainPlayerInfo = f2_arg0:AddWidget( "MainPlayerInfoContainer", {
				scalable = true,
				shakeable = true,
				leftAnchor = true,
				rightAnchor = false,
			...
			f2_arg0.challengeActive = f2_arg0:AddWidget( "ChallengeMeterContainer", {
				scalable = true,
				shakeable = true,
				leftAnchor = true,
				rightAnchor = false,
			...
			f2_arg0.questFullScreenSplash = f2_arg0:AddWidget( "questFullScreenSplash", {
				scalable = true,
				shakeable = true,
				leftAnchor = true,
				rightAnchor = false,
			...
			f2_arg0.localPlayerZombieSplashes = f2_arg0:AddWidget( "LocalPlayerZombieSplashContainer", {
				scalable = true,
				shakeable = true,
			...
			f2_arg0.songSplash = f2_arg0:AddWidget( "SongSplash", {
				scalable = true,
				shakeable = true,
				leftAnchor = true,
				rightAnchor = false,
			...
			f2_arg0.ghostHUDContainer = f2_arg0:AddWidget( "ghostHUDContainer", {
				scalable = true,
				shakeable = true,
				leftAnchor = true,
				rightAnchor = true,
			...
			f2_arg0:registerOmnvarHandler( "zm_arcade_emulator", function ( f4_arg0, f4_arg1 )
				...
				elseif f4_arg1.value == "arcade_atlantis" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/atlantis.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_beamrid" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/beamrid1.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_boombang" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/boombang.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_command" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/command1.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_kaboom" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/kaboom1.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_ghostbu" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/ghostbu2.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_hero" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
					Engine.Exec( "vcs_start " .. "roms/hero1.bin " .. f4_arg1.controller, f4_arg1.controller )
				elseif f4_arg1.value == "arcade_megaman" then
					Engine.Exec( "vcs_stop " .. f4_arg1.controller, f4_arg1.controller )
			...
			local f2_local5 = 6
			for self = 0, f2_local5 - 1, 1 do
				local f2_local9 = DataSources.inGame.MP.splashes.omnvarList[self]
				f2_arg0:SubscribeToModel( f2_local9:GetModel( f2_arg1 ), LUI.ZMHUD.SplashSubscriptionHelper( f2_local9, DataSources.inGame.MP.splashes.paramList[self], DataSources.inGame.MP.splashes.cardClientIdList[self], f2_arg1 ), true )
			end
			...
			LUI.ZMHUD.RegisterSplashHandlers( f2_arg0 )
...
LUI.ZMHUD.GetToggleWidgets = function ( f9_arg0 )
...
LUI.ZMHUD.SplashSubscriptionHelper = function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
	return function ()
...
LUI.ZMHUD.RegisterSplashHandlers = function ( f12_arg0 )
