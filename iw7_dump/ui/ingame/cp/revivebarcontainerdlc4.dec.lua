...
function ReviveBarContainerDLC4( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 256 * _1080p, 0, 64 * _1080p )
	self.id = "ReviveBarContainerDLC4"
	self._animationSets = {}
	self._sequences = {}
	...
	Accent.id = "Accent"
	Accent:setImage( RegisterMaterial( "cp_final_revive_bar_bg" ), 0 )
	Accent:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 21.8, _1080p * 245.8, _1080p * -31, _1080p * 97 )
	self:addElement( Accent )
	self.Accent = Accent
	
	local Header = nil
	
	Header = MenuBuilder.BuildRegisteredType( "ReviveBarHeaderDLC1", {
		controllerIndex = f4_local1
	} )
	Header.id = "Header"
	Header:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 51, _1080p * 201, _1080p * -60, _1080p * -28 )
	self:addElement( Header )
	self.Header = Header
	
	local ProgressBar = nil
	
	ProgressBar = MenuBuilder.BuildRegisteredType( "ReviveProgressBarDLC4", {
		controllerIndex = f4_local1
	} )
	ProgressBar.id = "ProgressBar"
	ProgressBar:SetScale( -0.13, 0 )
	ProgressBar:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 33.8, _1080p * 253.8, _1080p * 17, _1080p * 49 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		Accent:RegisterAnimationSequence( "Show", {
			{
				...
				function ()
					return self.Accent:SetScale( 0, 150, LUI.EASING.outBack )
				end
			},
			{
				function ()
				...
				function ()
					return self.Accent:SetAlpha( 0.7, 150, LUI.EASING.outBack )
				end,
				function ()
					return self.Accent:SetAlpha( 1, 40 )
				end
			}
		} )
		...
		ProgressBar:RegisterAnimationSequence( "Show", {
			{
				...
				function ()
					return self.ProgressBar:SetScale( -0.12, 150 )
				end
			},
			{
				function ()
				...
				function ()
					return self.ProgressBar:SetAlpha( 1, 150 )
				end
			}
		} )
		...
		Accent:RegisterAnimationSequence( "Hide", {
			{
				function ()
					return self.Accent:SetAlpha( 1, 0 )
				end,
				function ()
					return self.Accent:SetAlpha( 0, 150 )
				end
			},
			{
				function ()
					return self.Accent:SetScale( 0, 0 )
				end,
				function ()
					return self.Accent:SetScale( -1, 150 )
				end
			}
		} )
		...
		ProgressBar:RegisterAnimationSequence( "Hide", {
			{
				...
				function ()
					return self.ProgressBar:SetAlpha( 0, 150 )
				end
			},
			{
				function ()
					return self.ProgressBar:SetScale( -0.12, 0 )
				end,
				function ()
					return self.ProgressBar:SetScale( -1, 150 )
				end
			}
		} )
...
MenuBuilder.registerType( "ReviveBarContainerDLC4", ReviveBarContainerDLC4 )
LockTable( _M )
