...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	local f1_local0 = function ( f2_arg0, f2_arg1 )
		f2_arg0:SetEntityNum( Game.GetOmnvar( "zm_ui_constant_1_ent" ) )
		f2_arg0:SetEntityTag( "tag_origin" )
		f2_arg0:SetFollowTagAngles( true )
		f2_arg0:SetTagSpacePosition( -2, 0, 1 )
		f2_arg0:SetTagSpaceYaw( 0 )
		f2_arg0:SetTagSpaceRoll( -90 )
	end
	
	f1_arg0:registerOmnvarHandler( "zm_ui_constant_1_ent", f1_local0 )
	f1_local0( f1_arg0, {} )
end

function constant1( menu, controller )
	...
	constantWidget:SetScale( 0.61, 0 )
	constantWidget.number:SetRGBFromInt( 8224125, 0 )
	constantWidget.number:SetAlpha( 0.7, 0 )
	constantWidget:SetAnchorsAndPosition( 0, 1, 0, 1, 0, _1080p * 400, 0, _1080p * 400 )
	constantWidget:SubscribeToModel( DataSources.inGame.CP.zombies.dlc3.constantLoc1:GetModel( f3_local1 ), function ()
		local f4_local0 = DataSources.inGame.CP.zombies.dlc3.constantLoc1:GetValue( f3_local1 )
		if f4_local0 ~= nil then
			constantWidget.number:setText( f4_local0, 0 )
		end
	end )
	constantWidget.notEqual:BindAlphaToModel( DataSources.inGame.CP.zombies.dlc3.constant1BadAlphaFilter:GetModel( f3_local1 ) )
...
MenuBuilder.registerType( "constant1", constant1 )
LockTable( _M )
