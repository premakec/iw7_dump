LUI.ZMHUDDLC4 = LUI.Class( LUI.HUD )
...
LUI.ZMHUDDLC4.init = function ( f2_arg0, f2_arg1 )
	LUI.ZMHUDDLC4.super.init( f2_arg0, f2_arg1 )
	f2_arg0.id = "ZMHUDDLC4"
	...
	if f2_local0 then
		...
		if not f2_local1 then
			...
			f2_arg0.reviveBarContainer = f2_arg0:AddWidget( "ReviveBarContainerDLC4", {
				scalable = true,
				shakeable = true,
				leftAnchor = false,
				rightAnchor = false,
			...
			f2_arg0.mainPlayerInfo = f2_arg0:AddWidget( "MainPlayerInfoContainerDLC4", {
				scalable = true,
				shakeable = true,
				leftAnchor = true,
				rightAnchor = false,
			...
			f2_arg0.questFullScreenSplash = f2_arg0:AddWidget( "questFullScreenSplashDLC4", {
				scalable = true,
				shakeable = true,
			...
			f2_arg0.ghostStepFollowLightTimer = f2_arg0:AddWidget( "ghostStepFollowLightTimerContainer", {
				scalable = true,
				shakeable = true,
				leftAnchor = true,
				rightAnchor = true,
			...
			f2_arg0.localPlayerZombieSplashes = f2_arg0:AddWidget( "LocalPlayerZombieSplashDLC4Container", {
				scalable = true,
				shakeable = true,
				useFullscreenHUDMask = true,
				leftAnchor = false,
			...
			for self = 0, f2_local7 - 1, 1 do
				...
				f2_arg0:SubscribeToModel( f2_local11:GetModel( f2_arg1 ), LUI.ZMHUDDLC4.SplashSubscriptionHelper( f2_local11, DataSources.inGame.MP.splashes.paramList[self], DataSources.inGame.MP.splashes.cardClientIdList[self], f2_arg1 ), true )
			end
			...
			LUI.ZMHUDDLC4.RegisterSplashHandlers( f2_arg0 )
...
LUI.ZMHUDDLC4.GetToggleWidgets = function ( f9_arg0 )
...
LUI.ZMHUDDLC4.SplashSubscriptionHelper = function ( f10_arg0, f10_arg1, f10_arg2, f10_arg3 )
	return function ()
...
LUI.ZMHUDDLC4.RegisterSplashHandlers = function ( f12_arg0 )
