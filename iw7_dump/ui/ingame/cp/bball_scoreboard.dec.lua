...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	f1_arg0:SetWorldSpacePosition( 2132, -1162.5, 228.25 )
...
function bball_scoreboard( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 491 * _1080p, 0, 81 * _1080p )
	self.id = "bball_scoreboard"
	self._animationSets = {}
	self._sequences = {}
	...
	CurSpawned:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 319.38, _1080p * 437.38, _1080p * 24.5, _1080p * 52.5 )
	CurSpawned:SubscribeToModel( DataSources.inGame.CP.zombies.bball1Score:GetModel( f3_local1 ), function ()
		local f4_local0 = DataSources.inGame.CP.zombies.bball1Score:GetValue( f3_local1 )
	...
	CurDead:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 155.5, _1080p * 274.5, _1080p * 24.5, _1080p * 52.5 )
	CurDead:SubscribeToModel( DataSources.inGame.CP.zombies.bball1Time:GetModel( f3_local1 ), function ()
		local f5_local0 = DataSources.inGame.CP.zombies.bball1Time:GetValue( f3_local1 )
	...
	CurDeadCopy0:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * -21.5, _1080p * 97.5, _1080p * 24.5, _1080p * 52.5 )
	CurDeadCopy0:SubscribeToModel( DataSources.inGame.CP.zombies.bball1HiScore:GetModel( f3_local1 ), function ()
		local f6_local0 = DataSources.inGame.CP.zombies.bball1HiScore:GetValue( f3_local1 )
...
MenuBuilder.registerType( "bball_scoreboard", bball_scoreboard )
LockTable( _M )
