...
function entanglerWidget( menu, controller )
	...
	deploySCU:setText( Engine.Localize( "CP_ZMB_GHOST_KILL_GHOST" ), 0 )
	...
	deploySCU:SetAnchorsAndPosition( 0, 0, 0, 1, _1080p * -51.5, _1080p * 76.5, 0, _1080p * 18 )
	...
	tracking:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 274, _1080p * 351, _1080p * 32, _1080p * 49 )
...
MenuBuilder.registerType( "entanglerWidget", entanglerWidget )
LockTable( _M )
