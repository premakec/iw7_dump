...
function BossPlayer4( menu, controller )
	...
	Score:SubscribeToModel( DataSources.inGame.CP.zombies.bossTimePlayer4:GetModel( f3_local1 ), function ()
		local f4_local0 = DataSources.inGame.CP.zombies.bossTimePlayer4:GetValue( f3_local1 )
...
MenuBuilder.registerType( "BossPlayer4", BossPlayer4 )
LockTable( _M )
