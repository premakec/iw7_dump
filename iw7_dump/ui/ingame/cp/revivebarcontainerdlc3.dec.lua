...
function ReviveBarContainerDLC3( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 256 * _1080p, 0, 64 * _1080p )
	self.id = "ReviveBarContainerDLC3"
	self._animationSets = {}
	self._sequences = {}
	...
	Accent.id = "Accent"
	Accent:setImage( RegisterMaterial( "cp_town_revive_bar_bg" ), 0 )
	Accent:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 31.8, _1080p * 255, _1080p * -32, _1080p * 96 )
	...
	ProgressBar = MenuBuilder.BuildRegisteredType( "ReviveProgressBarDLC3", {
		controllerIndex = f4_local1
	} )
...
MenuBuilder.registerType( "ReviveBarContainerDLC3", ReviveBarContainerDLC3 )
LockTable( _M )
