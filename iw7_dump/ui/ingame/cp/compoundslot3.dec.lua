...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	local f1_local0 = function ( f2_arg0, f2_arg1 )
		f2_arg0:SetEntityNum( Game.GetOmnvar( "zm_chem_compound_slot_3_ent" ) )
...
function compoundSlot3( menu, controller )
	...
	compoundName:BindAlphaToModel( DataSources.inGame.CP.zombies.dlc3.compoundSlot3AlphaFilter:GetModel( f3_local1 ) )
	compoundName:SubscribeToModel( DataSources.inGame.CP.zombies.dlc3.compoundSlot3NameFilter:GetModel( f3_local1 ), function ()
		local f4_local0 = DataSources.inGame.CP.zombies.dlc3.compoundSlot3NameFilter:GetValue( f3_local1 )
...
MenuBuilder.registerType( "compoundSlot3", compoundSlot3 )
LockTable( _M )
