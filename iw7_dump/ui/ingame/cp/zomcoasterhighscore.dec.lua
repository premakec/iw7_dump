...
function PostLoadFunc( f1_arg0, f1_arg1 )
	...
	f1_arg0:SetWorldSpacePosition( -690, -2656, 661 )
	...
	local f1_local1 = DataSources.inGame.CP.zombies.coasterPicP1:GetModel( f1_arg1 )
	f1_arg0:SubscribeToModel( f1_local1, f1_local0 )
	f1_arg0:SubscribeToModel( DataSources.inGame.CP.zombies.coasterHighScoreP1:GetModel( f1_arg1 ), function ()
...
function ZomCoasterHighScore( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 128 * _1080p, 0, 128 * _1080p )
	self.id = "ZomCoasterHighScore"
	self._animationSets = {}
	self._sequences = {}
	...
	score4:SubscribeToModel( DataSources.inGame.CP.zombies.coasterHighScoreP1:GetModel( f4_local1 ), function ()
		local f5_local0 = DataSources.inGame.CP.zombies.coasterHighScoreP1:GetValue( f4_local1 )
...
MenuBuilder.registerType( "ZomCoasterHighScore", ZomCoasterHighScore )
LockTable( _M )
