...
function HardpointCalloutArea( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 200 * _1080p, 0, 24 * _1080p )
	self.id = "HardpointCalloutArea"
	...
	Label0:setTextStyle( CoD.TextStyle.Shadowed )
	Label0:SetAlignment( LUI.Alignment.Left )
	Label0:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 4, _1080p * 196, _1080p * 1, _1080p * 23 )
	Label0:SubscribeToModel( DataSources.inGame.MP.hardpointCalloutAreaString:GetModel( f1_local1 ), function ()
		local f2_local0 = DataSources.inGame.MP.hardpointCalloutAreaString:GetValue( f1_local1 )
...
MenuBuilder.registerType( "HardpointCalloutArea", HardpointCalloutArea )
LockTable( _M )
