...
f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	local f1_local0 = DataSources.inGame.MP.match.teamScoreEnemyWinRatio
	local f1_local1 = function ()
		local f2_local0 = f1_local0:GetValue( f1_arg1 )
		if f2_local0 ~= nil then
			f1_arg0.MatchStatusScoreBar.Fill:SetAnchorsAndPosition( LUI.clamp( 1 - f2_local0, 0, 1 ), 0, 0, 0, 1, 0, 0, 0, 100 )
		end
	end
...
function MatchStatusEnemyScoreBar( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 100 * _1080p, 0, 8 * _1080p )
	self.id = "MatchStatusEnemyScoreBar"
	...
	MatchStatusScoreBar:SetZRotation( 180, 0 )
	MatchStatusScoreBar.Fill:SetRGBFromTable( SWATCHES.HUD.enemyTeam, 0 )
	MatchStatusScoreBar.Fill:SetZRotation( 0, 0 )
...
MenuBuilder.registerType( "MatchStatusEnemyScoreBar", MatchStatusEnemyScoreBar )
LockTable( _M )
