...
f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	return function ()
		...
		if not f1_arg0.contractComplete then
			local f2_local0 = Contracts.CheckCompletion( f1_arg1, f1_arg0.contractData.index )
			local f2_local1 = Contracts.GetCurrentChallengeProgress( f1_arg1, f1_arg0.contractData.index )
			local f2_local2 = tonumber( f1_arg0.contractData.challengeData.target )
			f1_arg0.FractionText:setText( Engine.Localize( "LUA_MENU_MP_PROGRESS_TOTAL", Contracts.GetCurrentChallengeProgress( f1_arg1, f1_arg0.contractData.index ), f2_local2 ) )
			assert( f2_local2 ~= 0 )
			f1_arg0.ProgressBar.Fill:SetRightAnchor( LUI.clamp( 1 - f2_local1 / f2_local2, 0, 1 ), f1_arg2 )
		end
	end
...
f0_local1 = function ( f3_arg0, f3_arg1, f3_arg2, f3_arg3 )
	assert( f3_arg0.Type )
	assert( f3_arg0.MissionTeamIcon )
	...
	if f3_arg0.contractData.teamIndex ~= -1 then
		...
		f3_arg0.MissionTeamIcon:setImage( f3_arg0.contractData.teamImage )
		...
		f3_arg0.MissionTeamIconBacker:SetAlpha( 1, 0 )
	end
	local f3_local0 = ""
	if f3_arg0.contractData.teamIndex ~= -1 then
		local f3_local1 = MissionDirector.GetActiveMissionTeam( f3_arg1 )
		local f3_local2 = MissionDirector.GetMissionTeamName( f3_arg0.contractData.teamIndex )
		if f3_local1 ~= f3_arg0.contractData.teamIndex then
			f3_local0 = Engine.Localize( "LUA_MENU_MP_CONTRACT_REQUIREMENT_USE", f3_local2 )
		end
	end
	...
	f3_arg0:SubscribeToModel( f3_local1.contracts.challenges[f3_arg3].progress.GetModel( f3_local2.progress, f3_arg1 ), f0_local0( f3_arg0, f3_arg1, 250 ), true )
	local f3_local3 = f0_local0( f3_arg0, f3_arg1, 0 )
	f3_local3()
end
...
function SmallContract( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 455 * _1080p, 0, 160 * _1080p )
	self.id = "SmallContract"
	self._animationSets = {}
	self._sequences = {}
	...
	Background:SetRGBFromTable( SWATCHES.Contracts.JointContract, 0 )
	...
	LabelBacker:SetRGBFromTable( SWATCHES.Contracts.JointContract, 0 )
	...
	LabelBacker:SetAnchorsAndPosition( 0, 1, 0, 1, 0, _1080p * 374, 0, _1080p * 32 )
	...
	LabelBackerAngle:SetRGBFromTable( SWATCHES.Contracts.JointContract, 0 )
	...
	DescriptionText:SetAnchorsAndPosition( 0, 0, 0, 1, _1080p * 70.5, _1080p * -27.5, _1080p * 40.25, _1080p * 60.25 )
	...
	FractionText:SetAnchorsAndPosition( 1, 0, 1, 0, _1080p * -155, _1080p * -7, _1080p * -24.75, _1080p * -3.25 )
	...
	ProgressBar:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 10, _1080p * 297, _1080p * 140, _1080p * 152 )
	...
	CompleteBar:SetAnchorsAndPosition( 0, 0, 1, 0, 0, 0, _1080p * -28, 0 )
	...
	CompleteText:setText( ToUpperCase( Engine.Localize( "LUA_MENU_MP_CONTRACT_COMPLETE" ) ), 0 )
	...
	CompleteText:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 49, _1080p * 275, _1080p * 84, _1080p * 108 )
	...
	Border.id = "Border"
	Border:SetRGBFromTable( SWATCHES.Contracts.JointContract, 0 )
	...
	local MissionTeamIconBacker = nil
	
	MissionTeamIconBacker = LUI.UIImage.new()
	MissionTeamIconBacker.id = "MissionTeamIconBacker"
	MissionTeamIconBacker:SetAlpha( 0, 0 )
	MissionTeamIconBacker:SetGlitchEnabled( true )
	MissionTeamIconBacker:SetGlitchAmount( 0, 0 )
	MissionTeamIconBacker:SetGlitchBlockWidth( 50, 0 )
	MissionTeamIconBacker:SetGlitchBlockHeight( 50, 0 )
	MissionTeamIconBacker:SetGlitchDistortionRange( 16, 0 )
	MissionTeamIconBacker:SetGlitchScanlinePitch( 1, 0 )
	MissionTeamIconBacker:SetGlitchMaskPitch( 1, 0 )
	MissionTeamIconBacker:setImage( RegisterMaterial( "mp_mt_contract_backing" ), 0 )
	MissionTeamIconBacker:SetAnchorsAndPosition( 1, 0, 0, 1, _1080p * -523, _1080p * -375, _1080p * -5, _1080p * 143 )
	self:addElement( MissionTeamIconBacker )
	self.MissionTeamIconBacker = MissionTeamIconBacker
	
	local MissionTeamIcon = nil
	
	MissionTeamIcon = LUI.UIImage.new()
	MissionTeamIcon.id = "MissionTeamIcon"
	MissionTeamIcon:SetGlitchEnabled( true )
	MissionTeamIcon:SetGlitchAmount( 0, 0 )
	MissionTeamIcon:SetGlitchBlockWidth( 50, 0 )
	MissionTeamIcon:SetGlitchBlockHeight( 50, 0 )
	MissionTeamIcon:SetGlitchDistortionRange( 16, 0 )
	MissionTeamIcon:SetGlitchScanlinePitch( 1, 0 )
	MissionTeamIcon:SetGlitchMaskPitch( 1, 0 )
	MissionTeamIcon:setImage( RegisterMaterial( "mission_team_joint_ops_icon" ), 0 )
	MissionTeamIcon:SetAnchorsAndPosition( 1, 0, 0, 1, _1080p * -523, _1080p * -375, _1080p * -12.75, _1080p * 135.25 )
	...
	Type:SetAnchorsAndPosition( 0, 0, 0, 1, _1080p * 70.5, _1080p * -81.5, _1080p * 7, _1080p * 25 )
	...
	RequirementText:SetAnchorsAndPosition( 0, 0, 0, 1, _1080p * 70.5, _1080p * -27.5, _1080p * 92, _1080p * 112 )
	...
	self._animationSets.DefaultAnimationSet = function ()
		...
		CompleteBar:RegisterAnimationSequence( "ContractComplete", {
			...
			{
				function ()
					return self.CompleteBar:SetRGBFromTable( SWATCHES.genericButton.highlight, 0 )
				end
			},
			{
				function ()
		...
		CompleteText:RegisterAnimationSequence( "ContractComplete", {
			...
			{
				function ()
					return self.CompleteText:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 29, _1080p * 285, _1080p * 99, _1080p * 123, 300 )
				end,
				function ()
					return self.CompleteText:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 67, _1080p * 338, _1080p * 99, _1080p * 123, 199, LUI.EASING.outSine )
				end,
				function ()
					return self.CompleteText:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 67, _1080p * 338, _1080p * 99, _1080p * 123, 449 )
				end
			}
		} )
		...
		MissionTeamIcon:RegisterAnimationSequence( "Bootup", {
			{
				function ()
			...
			{
				function ()
					return self.MissionTeamIcon:SetGlitchAmount( 1, 0 )
				end,
				function ()
					return self.MissionTeamIcon:SetGlitchAmount( 0, 110 )
				end
			},
			{
				function ()
					return self.MissionTeamIcon:SetGlitchBlockWidth( 10, 0 )
				end,
				function ()
					return self.MissionTeamIcon:SetGlitchBlockWidth( 1, 110 )
				end
			},
			{
				function ()
					return self.MissionTeamIcon:SetGlitchBlockHeight( 10, 0 )
				end,
				function ()
					return self.MissionTeamIcon:SetGlitchBlockHeight( 16, 110 )
				end
			},
			{
				function ()
					return self.MissionTeamIcon:SetGlitchDistortionRange( 16, 0 )
				end,
				function ()
					return self.MissionTeamIcon:SetGlitchDistortionRange( 30, 110 )
				end
			},
			{
				function ()
					return self.MissionTeamIcon:SetGlitchScanlinePitch( 60, 0 )
				end,
				function ()
					return self.MissionTeamIcon:SetGlitchScanlinePitch( 60, 110 )
				end
			},
			{
				function ()
					return self.MissionTeamIcon:SetGlitchMaskPitch( 50, 0 )
				end,
				function ()
					return self.MissionTeamIcon:SetGlitchMaskPitch( 50, 110 )
				end
			}
		} )
		...
		self._sequences.Bootup = function ()
			...
			MissionTeamIcon:AnimateSequence( "Bootup" )
...
MenuBuilder.registerType( "SmallContract", SmallContract )
LockTable( _M )
