...
function ThermalVisionFriendlyVenom( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920 * _1080p, 0, 1080 * _1080p )
	self.id = "ThermalVisionFriendlyVenom"
...
MenuBuilder.registerType( "ThermalVisionFriendlyVenom", ThermalVisionFriendlyVenom )
LockTable( _M )
